...
//        ConfXYZ(nconf);//Write actual configuration in XYZ format //Commented to avoid "filesystem full"! 
    ...
    Averages(iblk);
    ConfXYZ(10);   //Print results for current block
  }
...
// distance i-j in pbc
  ...
  walker[ip] = rho*walker[it] + (1./(3.*vol))*viriale;   //Pressure
...
void Averages(int iblk) //Print results for current block
{
   ...
   ofstream Epot, Ekin, Etot, Temp, Pres;
    ...
    Epot.open("gas/gas_epot.dat",ios::app);
    Ekin.open("gas/gas_ekin.dat",ios::app);
    Temp.open("gas/gas_temp.dat",ios::app);
    Etot.open("gas/gas_etot.dat",ios::app);
    Pres.open("gas/gas_pres.dat",ios::app);
